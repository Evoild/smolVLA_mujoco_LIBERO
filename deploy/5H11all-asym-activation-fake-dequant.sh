...
OUTPUT_ROOT="$REPO_ROOT/runs/deploy/5/H-bf16-int8-w8a8/all_asym_activation"
...
# W8A8:
#   q/k/v/o + gate/up/down: asymmetric activation A8 + symmetric per-output-channel W8
...
ASYMMETRIC_MODULE_REGEX="$QUANT_MODULE_REGEX"
...
SCALES_JSON="$OUTPUT_ROOT/activation_scales_${CALIBRATION_SAMPLES}_p${CALIBRATION_PERCENTILE}_all_asym.json"
...
printf '%s\n' "step 5H.11 all activation asymmetric fake-dequant outputs:" \
