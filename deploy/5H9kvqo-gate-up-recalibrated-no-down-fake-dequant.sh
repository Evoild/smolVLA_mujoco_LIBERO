...
OUTPUT_ROOT="$REPO_ROOT/runs/deploy/5/H-bf16-int8-w8a8/kvqo_gate_up_recalibrated_no_down"
...
QUANT_MODULE_REGEX="^model\\.vlm_with_expert\\.vlm\\.model\\.text_model\\.layers\\.[0-9]+\\.(self_attn\\.(q_proj|k_proj|v_proj|o_proj)|mlp\\.(gate_proj|up_proj))$"
...
printf '%s\n' "step 5H.9 recalibrated KVQO+gate/up no-down fake-dequant outputs:" \
