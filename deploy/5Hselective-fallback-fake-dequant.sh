...
OUTPUT_ROOT="$REPO_ROOT/runs/deploy/5/H-bf16-int8-w8a8/selective_o18_31_down3_13_30_bf16"
...
#   gate/up: all layers
#   o_proj: layers 0-17
#   down_proj: all layers except 3, 13, 30
# BF16 fallback:
#   o_proj: layers 18-31
#   down_proj: layers 3, 13, 30
QUANT_MODULE_REGEX="^model\\.vlm_with_expert\\.vlm\\.model\\.text_model\\.layers\\.((([0-9]|[12][0-9]|3[01])\\.(self_attn\\.(q_proj|k_proj|v_proj)|mlp\\.(gate_proj|up_proj)))|(([0-9]|1[0-7])\\.self_attn\\.o_proj)|(([0-2]|[4-9]|1[0-2]|1[4-9]|2[0-9]|31)\\.mlp\\.down_proj))$"
...
printf '%s\n' "step 5H selective BF16 fallback fake-dequant outputs:" \
