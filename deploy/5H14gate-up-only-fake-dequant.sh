...
OUTPUT_ROOT="$REPO_ROOT/runs/deploy/5/H-bf16-int8-w8a8/gate_up_only_recalibrated"
...
# BF16:
#   q/k/v/o/down: all layers
#
# This isolates whether the remaining MLP-shaped error in 5H.8/5H.9/5H.13
# is mainly caused by gate_proj/up_proj quantization.
QUANT_MODULE_REGEX="^model\\.vlm_with_expert\\.vlm\\.model\\.text_model\\.layers\\.[0-9]+\\.mlp\\.(gate_proj|up_proj)$"
...
printf '%s\n' "step 5H.14 gate/up only fake-dequant outputs:" \
