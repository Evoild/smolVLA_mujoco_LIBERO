...
OUTPUT_ROOT="$REPO_ROOT/runs/deploy/5/H-bf16-int8-w8a8/percentile_sweep"
...
PERCENTILES=(99.0 99.5 99.9 99.95 99.99 99.995 99.999)
COMPARE_SAMPLES=50
SAMPLE_STRIDE=5
...
for percentile in "${PERCENTILES[@]}"; do
  ...
  scales_json="$run_dir/activation_scales_p${percentile}.json"
  mkdir -p "$run_dir"
...
printf '%s\n' "step 5H per-tensor percentile sweep outputs:" \
  "  output root: $OUTPUT_ROOT" \
