...
OUTPUT_ROOT="$REPO_ROOT/runs/deploy/3-6/E-layer-mlp-compare/single_modules"
DEVICE=cuda
SEED=1000
BATCH_SIZE=1
TOKEN_LENGTH=48
...
"$PYTHON" "$SCRIPT_DIR/compare_single_mlp_modules.py" \
...
printf '%s\n' "step 3-6E single MLP module compare outputs:" \
  "  output root: $OUTPUT_ROOT" \
  "  summary json: $OUTPUT_ROOT/single_mlp_module_compare_summary.json" \
  "  rows csv: $OUTPUT_ROOT/single_mlp_module_compare_rows.csv" \
