...
OUTPUT_ROOT="$REPO_ROOT/runs/deploy/5/H-bf16-int8-w8a8/qk_gate_up_recalibrated_no_v_no_o_no_down"
...
# W8A8:
#   q/k: all layers
#   FFN gate/up: all layers
# BF16:
#   v_proj/o_proj/down_proj: all layers
#
# This is the v_proj ablation for 5H.8:
#   5H.8 = q/k/v + gate/up W8A8, o/down BF16
#   5H.13 = q/k   + gate/up W8A8, v/o/down BF16
QUANT_MODULE_REGEX="^model\\.vlm_with_expert\\.vlm\\.model\\.text_model\\.layers\\.[0-9]+\\.(self_attn\\.(q_proj|k_proj)|mlp\\.(gate_proj|up_proj))$"
...
printf '%s\n' "step 5H.13 QK+gate/up no-v no-o no-down fake-dequant outputs:" \
